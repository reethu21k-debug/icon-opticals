...
export function buildOrderConfirmationEmail(order: Order, userName: string): string {
  ...
  const inner = `
    ...
    ${cardFooterRow(`Questions? Call us at <a href="tel:9676227094" style="color:#D4AA5A;text-decoration:none;">+91 96762 27094</a>`)}
  `
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          <tr>
            ...
            <td style="background:#030811;border:1px solid #0E1628;border-left:none;
              ...
              <strong style="color:#C8D4E8;font-weight:500;">+91 96762 27094</strong>.
            </td>
          </tr>
        </table>
      </td>
